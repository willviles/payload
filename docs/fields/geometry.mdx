...
label: Geometry
order: 110
desc: The Geometry field type stores coordinates in the database. Learn how to use Geometry field for geolocation and geometry.
...
<Banner>
  The Geometry field type saves a pair of coordinates in the database and assigns an index for location
  related queries.
</Banner>

<Banner type="warning">
  <strong>Note:</strong> The Geometry field type is currently only supported in MongoDB.
</Banner>

<LightDarkImage
  srcLight="https://payloadcms.com/images/docs/fields/point.png"
  srcDark="https://payloadcms.com/images/docs/fields/point-dark.png"
  alt="Shows a Geometry field in the Payload admin panel"
  caption="Admin panel screenshot of a Geometry field"
/>
